...
export interface SyncPreferences {
  ...
  calendar: {
    ...
    included_courses: string[]; // Empty array = all courses
...
export const DEFAULT_PREFERENCES: SyncPreferences = {
  ...
  calendar: {
    event_types: ['event'], // Only calendar events (seminars, meetings, etc.)
  ...
  tasks: {
    event_types: ['assignment'], // All graded work (assignments, quizzes, etc.)
    included_courses: [], // Empty = all courses
    excluded_courses: [],
